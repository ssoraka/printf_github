...
int main(void)
{
	int t = 0;
	int len = 20;
	long double ld = 10;.0;
	char *str = NULL;
	int i = 0;

	ld = 1919999999999991111.99999999099000;
	//ld = 0;
	//printf("%s\n", ft_ldtoa3(ld, t));
...
/*  запуск вывода числа с плавающей точкой в логарифмическом виде */
	while (i < 100)
	{
		//str = ft_ldtoa_final_e1(ld, t);
		printf("%d\n", i);
		str = ft_ldtoa_final_g(ld, i);
		printf("%s\n", str);
		//str = ft_ldtoa_final(ld, 0, 1);
		//printf("%s\n", str);
		printf("%.*Lg\n", i, ld);
		free(str);
		str = NULL;
